...
/*
 * Documentation:
 * Progress — https://app.subframe.com/742f0f25ee8a/library?component=Progress_60964db0-a1bf-428b-b9d5-f34cdf58ea77
 */
...
const Indicator = React.forwardRef<HTMLElement, IndicatorProps>(function Indicator(
